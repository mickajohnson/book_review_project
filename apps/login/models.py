...
class UserManager(models.Manager):
    ...
    def reg_validator(self, alias, first_name, last_name, email, password, confirm_password):
        errors = []
        if not alias:
...
## returns an object with either {errors: list of errors}, or {user: user object}
    def add_user(self, alias, first_name, last_name, email, password, confirm_password):
        errors = self.reg_validator(alias, first_name, last_name, email, password, confirm_password)
        if errors:
